...
if(isset($_POST["catID"]) && is_numeric($_POST["catID"]) && isset($_POST["type"]) && isset($_POST["last"]) && 
	is_numeric($_POST["last"]) && $_SERVER['REQUEST_METHOD'] == "POST") {
...
else if(isset($_POST["type"]) && isset($_POST["last"]) && is_numeric($_POST["last"]) && isset($_POST["userID"]) && 
