...
<div id="settings-holder">
	<div class="content-padding">
    	...
    	<div id="username-change" class="padding-top">
        	...
        	<label for="username-change-input" title="Change your username">Change Username</label><img src="/images/ajax-loader-create.gif" class="validation-settings" width="16" height="16"/>
        ...
        <div id="password-change" class="padding-top">
        	...
        	<label for="pass-change" title="Your new password">New Password</label><img src="/images/ajax-loader-create.gif" class="validation-settings" width="16" height="16"/>
        	<input type="password" name="pass-change" id="pass-change" class="textInput" maxlength="50"/>
            <label for="pass-change2" class="margin-top" title="Your new password again">Verify Password</label><img src="/images/ajax-loader-create.gif" class="validation-settings" width="16" height="16"/>
