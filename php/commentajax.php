<?php
	...
	if(isset($_POST["comment"]) && strlen(trim($_POST["comment"])) > 0 && strlen($_POST["comment"]) <= 700 && isset($_POST["category"]) && is_numeric($_POST["category"]) && isset($_SESSION["user_id"]) && $_SERVER['REQUEST_METHOD'] == "POST") {
